...
public class Lampada {
    ...
    public static int compararPotencia(AcademyDevDojoJava.Atividade.Lista2.Dominio.Lampada lamp1, AcademyDevDojoJava.Atividade.Lista2.Dominio.Lampada lamp2) {
